...
by \Rfunction{createStructuralAdjacency} and the matrix returned 
by \Rfunction{createStatisticalAdjacency},
...
<<combine,eval=F,echo=TRUE>>=
###################################################################################
cons_adj <- combine(structure=struct_adj, statistical=stat_adj)
@
...
<<visualisation,eval=F,echo=TRUE,fig.show='hide'>>=
###################################################################################
