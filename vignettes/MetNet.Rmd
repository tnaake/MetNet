...
message("class(am): ", paste(class(struct_adj), collapse = ", "))
message("is AdjacencyMatrix: ", is(struct_adj, "AdjacencyMatrix"))

message("selected method:")
print(methods::selectMethod(
    "as.data.frame",
    class(struct_adj),
    optional = TRUE
))
...
print(methods::getClass(class(struct_adj)[1]))
