...
`addSpectralSimilarity` uses functionality from the `Spectra` package, in order to 
...
Features from `spectra` will be matched accordingly to the feature names in the 
...
If multiple methods have been used to generate the spectral matrices, different threshold parameters can be defined (for detailed description see thresholding of statistical)
