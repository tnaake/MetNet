...
the structural matrix. The `rtCorrection` does this check, if the
...
these threshold in each respective weighted adjacency matrix will be 
reported as unweighted edges. The unweighted adjacency matrices will be passed to the  
