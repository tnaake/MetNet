...
molecular weight difference $w_X$ is defined by 
$w_X = \vert w_A - w_B \vert$

where $w_A$ is the molecular weight
of substrate A, and $w_B$ is the molecular weight of product B 
...
matrix and second entry the character matrix.
