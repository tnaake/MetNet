...
test_correlation <- function() {
    ...
    checkEquals(sum(correlation(mat_test, correlation_adjust = "bonferroni", correlation_threshold = 1e-11)), 28)
    checkEquals(sum(correlation(mat_test, correlation_adjust = "none", correlation_threshold = 1e-11)), 33)
