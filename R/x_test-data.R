...
#' 
#' ## function to add specific features of x (defined by m/z and retention time) 
#' ## to x_test 
...
#' ## N'-N''-diferuloyl-spermidine/ N#,N$-Coumaroyl,sinapoyl spermidine isomer [M+H+]+ 498.260/498.261
