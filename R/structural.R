...
#' @usage inRangeWhich(m_1, m_2, functional_groups)
...
#' inRangeWhich(m_1, m_2, functional_groups)
#' @export
inRangeWhich <- function(m_1, m_2, functional_groups) {
...
#' @usage createStructuralAdjacency(x, functional_groups, ppm=5)
...
#' @export
createStructuralAdjacency <- function(x, functional_groups, ppm=5) {
    ...
    for (i in seq_len(ncol(mat))) {
        functional_group_vec <- lapply(seq_len(length(mass_1)), 
            function(x, z=i) {
                ...
                presence_l <- inRangeWhich(m_1, m_2, mass_fg)
